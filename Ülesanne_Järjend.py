...
def create_list_of_two_elements(a: int, b: int) -> list:
    ...
    """
    a = input(print("Anna esimene elemendi number: "))
    b = input(print("Anna teine elemendi number: "))
    print(create_list_of_two_elements[a:b])
    return create_list_of_two_elements()
    pass
