...
class Hand:
    ...
    def is_straight(self):
        ...
        values = sorted([self.values.index(c.value) for c in self.cards])
    ...
    def is_full_house(self):
        ...
        if len(self.cards) != 5:
            return False
        return sorted(self.value_count().values()) == [2, 3]
    ...
    def is_four_of_a_kind(self):
        ...
        if len(self.cards) != 5:
            return False
        return 4 in self.value_count().values()
    ...
    def is_three_of_a_kind(self):
        ...
        if len(self.cards) != 5:
            return False
        return 3 in self.value_count().values()
    ...
    def is_pair(self):
        ...
        if len(self.cards) != 5:
            return False
        return 2 in self.value_count().values()
    ...
    def __repr__(self):
        ...
        t = self.get_hand_type()
        if t:
            return f"I got a {t} with cards: {cards}"
        return f"I'm holding {cards}"
