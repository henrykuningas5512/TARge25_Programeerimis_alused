...
if __name__ == "__main__":
    ...
    print(loop_reverse("aaa"))
    print(loop_reverse(""))
    print(loop_reverse("1"))

    print(recursive_reverse("hey"))
    print(recursive_reverse("aaa"))
    print(recursive_reverse(""))
    print(recursive_reverse("1"))
    ...
    print(sum_digits_recursive(1))
    print(sum_digits_recursive(0))
    print(sum_digits_recursive(999))

    print(pair_star_recursive("aaa"))
    print(pair_star_recursive("aaabb"))
    print(pair_star_recursive("Mattias"))
